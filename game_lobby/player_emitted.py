    ...
    class _Player (_waldo_classes["Endpoint"]):
        ...
        def add_to_game(self):
            ...
            while True:  # FIXME: currently using infinite retry 
                ...
                # to Waldo variables, and de-waldo-ifying them outside of the
                # transaction might return over-written/inconsistent values.
                _to_return = self._endpoint_func_call_prefix__waldo__add_to_game(_root_event,_ctx ,[])
                # try committing root event
                _root_event.request_commit()
                _commit_resp = _root_event.event_complete_queue.get()
                if isinstance(_commit_resp,self._waldo_classes["CompleteRootCallResult"]):
        ...
        def _endpoint_func_call_prefix__waldo__add_to_game(self,_active_event,_context,_returning_to_public_ext_array=None):
            if _context.check_and_set_from_endpoint_call_false():
        ...
        def join_waiting_room(self):
            ...
            while True:  # FIXME: currently using infinite retry 
                ...
                # to Waldo variables, and de-waldo-ifying them outside of the
                # transaction might return over-written/inconsistent values.
                _to_return = self._endpoint_func_call_prefix__waldo__join_waiting_room(_root_event,_ctx ,[])
                # try committing root event
                _root_event.request_commit()
                _commit_resp = _root_event.event_complete_queue.get()
                if isinstance(_commit_resp,self._waldo_classes["CompleteRootCallResult"]):
        ...
        def _endpoint_func_call_prefix__waldo__join_waiting_room(self,_active_event,_context,_returning_to_public_ext_array=None):
            if _context.check_and_set_from_endpoint_call_false():
            ...
            (self._partner_endpoint_msg_func_call_prefix__waldo__JoinWaiting(_active_event,_context,) if _context.set_msg_send_initialized_bit_false() else None)
        ...
        def leave_waiting(self):
            ...
            while True:  # FIXME: currently using infinite retry 
                ...
                # to Waldo variables, and de-waldo-ifying them outside of the
                # transaction might return over-written/inconsistent values.
                _to_return = self._endpoint_func_call_prefix__waldo__leave_waiting(_root_event,_ctx ,[])
                # try committing root event
                _root_event.request_commit()
                _commit_resp = _root_event.event_complete_queue.get()
                if isinstance(_commit_resp,self._waldo_classes["CompleteRootCallResult"]):
        ...
        def _endpoint_func_call_prefix__waldo__leave_waiting(self,_active_event,_context,_returning_to_public_ext_array=None):
            if _context.check_and_set_from_endpoint_call_false():
            ...
            (self._partner_endpoint_msg_func_call_prefix__waldo__LeaveWaiting(_active_event,_context,) if _context.set_msg_send_initialized_bit_false() else None)


        def send_to_waiting(self,message):
            ...
            while True:  # FIXME: currently using infinite retry 
                ...
                # to Waldo variables, and de-waldo-ifying them outside of the
                # transaction might return over-written/inconsistent values.
                _to_return = self._endpoint_func_call_prefix__waldo__send_to_waiting(_root_event,_ctx ,message,[])
                # try committing root event
                _root_event.request_commit()
                _commit_resp = _root_event.event_complete_queue.get()
                if isinstance(_commit_resp,self._waldo_classes["CompleteRootCallResult"]):
        ...
        def _endpoint_func_call_prefix__waldo__send_to_waiting(self,_active_event,_context,message,_returning_to_public_ext_array=None):
            if _context.check_and_set_from_endpoint_call_false():
            ...
            _tmp0 = (_context.get_val_if_waldo('from ' ,_active_event) + _context.get_val_if_waldo((_context.get_val_if_waldo(_context.global_store.get_var_if_exists("0__username"),_active_event) + _context.get_val_if_waldo((_context.get_val_if_waldo(' in the waiting room: ' ,_active_event) + _context.get_val_if_waldo(message,_active_event)),_active_event)),_active_event))
            if not _context.assign(message,_tmp0,_active_event):
                message = _tmp0

            (self._partner_endpoint_msg_func_call_prefix__waldo__SendToWaiting(_active_event,_context,message,) if _context.set_msg_send_initialized_bit_false() else None)
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__GetAnagram(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                _context.sequence_local_store.add_var(
                    "22__anagram",_context.convert_for_seq_local(anagram,_active_event,self._host_uuid))
            ...
            return _context.sequence_local_store.get_var_if_exists("22__anagram")
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__GetSolutions(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                solutions = self._waldo_classes["WaldoSingleThreadListVariable"](  # the type of waldo variable to create
                    '25__solutions', # variable's name
                    self._host_uuid, # host uuid var name
                    False,  # if peered, True, otherwise, False
                    
                )
                _context.sequence_local_store.add_var(
                    "25__solutions",_context.convert_for_seq_local(solutions,_active_event,self._host_uuid))
            ...
            return _context.sequence_local_store.get_var_if_exists("25__solutions")
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__GameInSession(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                game_status = False
                _context.sequence_local_store.add_var(
                    "28__game_status",_context.convert_for_seq_local(game_status,_active_event,self._host_uuid))
            ...
            return _context.sequence_local_store.get_var_if_exists("28__game_status")
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__JoinWaiting(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _threadsafe_queue = self._waldo_classes["Queue"].Queue()
            _active_event.issue_partner_sequence_block_call(
                _context,'addPlayer',_threadsafe_queue, '_first_msg')
            _queue_elem = _threadsafe_queue.get()
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__LeaveWaiting(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _threadsafe_queue = self._waldo_classes["Queue"].Queue()
            _active_event.issue_partner_sequence_block_call(
                _context,'removePlayer',_threadsafe_queue, '_first_msg')
            _queue_elem = _threadsafe_queue.get()
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__AddPoints(self,_active_event,_context,points=None,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "34__points", _context.convert_for_seq_local(points,_active_event,self._host_uuid)
                    )
                ...
                message = ""
                _context.sequence_local_store.add_var(
                    "33__message",_context.convert_for_seq_local(message,_active_event,self._host_uuid))
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__SendToWaiting(self,_active_event,_context,message=None,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "42__message", _context.convert_for_seq_local(message,_active_event,self._host_uuid)
                    )
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__displayMessage(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _context.call_func_obj(_active_event,_context.global_store.get_var_if_exists("1__print_message"),_context.sequence_local_store.get_var_if_exists("33__message"))
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__printMessage(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _context.call_func_obj(_active_event,_context.global_store.get_var_if_exists("1__print_message"),_context.sequence_local_store.get_var_if_exists("39__message"))
...
def PlayerHelper (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _PlayerHelper (_waldo_classes["Endpoint"]):
        def __init__(self,_waldo_classes,_host_uuid,_conn_obj,server):
            ...
            self._global_var_store.add_var(
                '17__game_server',self._waldo_classes["WaldoEndpointVariable"](  # the type of waldo variable to create
                '17__game_server', # variable's name
                _host_uuid, # host uuid var name
                False,  # if peered, True, otherwise, False
        ...
        def _onCreate(self,_active_event,_context,server,_returning_to_public_ext_array=None):
            ...
            _tmp0 = server
            if not _context.assign(_context.global_store.get_var_if_exists("17__game_server"),_tmp0,_active_event):
                pass
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__DisplayMessage(self,_active_event,_context,message=None,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "39__message", _context.convert_for_seq_local(message,_active_event,self._host_uuid)
                    )
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__setAnagram(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _tmp0 = _context.hide_endpoint_call(_active_event,_context,_context.get_val_if_waldo(_context.global_store.get_var_if_exists("17__game_server"),_active_event),"return_anagram",)
            if not _context.assign(_context.sequence_local_store.get_var_if_exists("22__anagram"),_tmp0,_active_event):
                pass
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__setList(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _tmp0 = _context.hide_endpoint_call(_active_event,_context,_context.get_val_if_waldo(_context.global_store.get_var_if_exists("17__game_server"),_active_event),"return_solutions",)
            if not _context.assign(_context.sequence_local_store.get_var_if_exists("25__solutions"),_tmp0,_active_event):
                pass
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__checkServer(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _tmp0 = _context.hide_endpoint_call(_active_event,_context,_context.get_val_if_waldo(_context.global_store.get_var_if_exists("17__game_server"),_active_event),"get_game_status",)
            if not _context.assign(_context.sequence_local_store.get_var_if_exists("28__game_status"),_tmp0,_active_event):
                pass
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__sendServer(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _context.hide_endpoint_call(_active_event,_context,_context.get_val_if_waldo(_context.global_store.get_var_if_exists("17__game_server"),_active_event),"add_player",_context.global_store.get_var_if_exists("0__username"),self,)
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__addPlayer(self,_active_event,_context,_returning_to_public_ext_array=None):

            _context.hide_endpoint_call(_active_event,_context,_context.get_val_if_waldo(_context.global_store.get_var_if_exists("17__game_server"),_active_event),"add_to_waiting",_context.global_store.get_var_if_exists("0__username"),self,)
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__removePlayer(self,_active_event,_context,_returning_to_public_ext_array=None):

            _context.hide_endpoint_call(_active_event,_context,_context.get_val_if_waldo(_context.global_store.get_var_if_exists("17__game_server"),_active_event),"remove_from_waiting",_context.global_store.get_var_if_exists("0__username"),)
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__addPoints(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            score = _context.get_val_if_waldo(_context.hide_endpoint_call(_active_event,_context,_context.get_val_if_waldo(_context.global_store.get_var_if_exists("17__game_server"),_active_event),"add_score",_context.global_store.get_var_if_exists("0__username"),_context.sequence_local_store.get_var_if_exists("34__points"),),_active_event)
            ...
            if not _context.assign(_context.sequence_local_store.get_var_if_exists("33__message"),_tmp0,_active_event):
                pass
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__sendMessage(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _context.hide_endpoint_call(_active_event,_context,_context.get_val_if_waldo(_context.global_store.get_var_if_exists("17__game_server"),_active_event),"broadcastWaitingMessage",_context.sequence_local_store.get_var_if_exists("42__message"),)
